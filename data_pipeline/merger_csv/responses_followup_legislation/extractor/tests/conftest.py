...
def commission_answers_rejection_legislation() -> list[tuple[bool, str, list[str]]]:
    return [
        ...
        (
            ...
            "2012/000005",
            [
                "Decision date: 28/05/2014Official documents related to the decision:",
        ...
        (
            ...
            [
                ...
                "In its reply, the Commission underlined that rather than proposing new legislative acts, the priority is to ensure thatthe proposals currently being negotiated by the co-legislators are timely adopted and then implemented, together with aneffective implementation of the CAP. Over one million statements in support of this citizens’ initiative are a clear signal and encouragement that the high level of ambition of the Commission proposals should be maintained.",
